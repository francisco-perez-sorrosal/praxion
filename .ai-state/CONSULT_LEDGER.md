...
| 2026-07-31T06:10:00Z | td-081-sealed-prior | statistician | architecture | CH-05 | The unit of noise is the spawn, not the consult, and the schema cannot record a replication -- between-run variance is unrecordable, not merely unmeasured | Whether the triple gains a replicate discriminator, and whether further spawns run before any ADR cites the rate | defer-with-rationale | td-084 | opus | standard |
