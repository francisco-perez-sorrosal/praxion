...
- [METR — Measuring the Impact of Early-2025 AI on Experienced Open-Source Developer Productivity](https://metr.org/blog/2025-07-10-early-2025-ai-experienced-os-dev-study/): RCT, experts on mature repos 19% slower with 43-point self-assessment error. **Has no scaffolding arm** — it says nothing about process weight; and the [2026 design update](https://metr.org/blog/2026-02-24-uplift-update/) reversed the point-estimate sign (−18% / −4%, CIs crossing zero) while declaring its data unreliable. Cite both or neither; never "19% slower" alone against ceremony · last-checked 2026-09-07
- [Gloaguen et al. — Evaluating AGENTS.md (arXiv 2602.11988)](https://arxiv.org/abs/2602.11988): benchmark ablation, 4 models, SWE-bench + 138-instance context-file benchmark; context files give no quality gain at +20–23% cost (p<0.001); tools *named* in instructions are used 1.6–2.5× more, repository overviews give no navigation gain — the instruction/overview split that governs what belongs in always-loaded context · last-checked 2026-09-07
- [Do Context Files Help Coding Agents? (arXiv 2607.27250)](https://arxiv.org/html/2607.27250v1): 288-run ablation on Claude Code + Codex; correctness equivalence-null (MDE ≈30 pp); selective (on-demand) context cut cache-creation tokens (p=0.012) and blind full-suite test runs 3.67→1.67 — the one positive measured signal for progressive disclosure · last-checked 2026-09-07
- [MAST — Why Do Multi-Agent LLM Systems Fail? (arXiv 2503.13657)](https://arxiv.org/abs/2503.13657): 1,600+ annotated traces, κ=0.88; failure families are system design, inter-agent misalignment, task verification — supports verification investment, indicts naive fan-out · last-checked 2026-09-07
- [SWR-Bench (arXiv 2509.01494)](https://arxiv.org/html/2509.01494v1) and [Bias in the Loop (arXiv 2604.16790)](https://arxiv.org/html/2604.16790v1): open-ended LLM code review reaches F1 19.4% at best; judge verdicts flip on authority and verbosity cues with the code unchanged — criteria-anchored, test-backed gates are the class that works; oracle-free prose judgment is not · last-checked 2026-09-07
