...
> substitution hypothesis is confirmed only when a high dismiss rate coincides with *indistinguishable
> unaided architect output* — is unchanged; only the sample unit is corrected.
