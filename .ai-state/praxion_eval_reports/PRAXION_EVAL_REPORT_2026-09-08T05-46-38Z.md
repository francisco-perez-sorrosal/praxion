...
| task_artifact_manifest | mechanical | FAIL | .ai-work/process-economy-phase1/TEST_RESULTS.md | N/A | Expected required artifact missing: Test-run evidence — required when a test step ran (TEST_BASELINE present). |
