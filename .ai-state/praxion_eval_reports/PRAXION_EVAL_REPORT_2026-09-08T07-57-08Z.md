...
|-------|------|---------|----------|-------|----------|
| task_artifact_manifest | mechanical | PASS | .ai-work/process-economy-phase1/SYSTEMS_PLAN.md | N/A | Expected artifact present: Architect's system plan with acceptance criteria. |
| task_artifact_manifest | mechanical | PASS | .ai-work/process-economy-phase1/IMPLEMENTATION_PLAN.md | N/A | Expected artifact present: Planner's step decomposition. |
| task_artifact_manifest | mechanical | PASS | .ai-work/process-economy-phase1/WIP.md | N/A | Expected artifact present: Live execution state. |
| task_artifact_manifest | mechanical | PASS | .ai-work/process-economy-phase1/LEARNINGS.md | N/A | Expected artifact present: In-flight learning capture; produced by every pipeline agent. |
...
| task_artifact_manifest | mechanical | PASS | .ai-work/process-economy-phase1/TEST_RESULTS.md | N/A | Expected artifact present: Test-run evidence — required when a test step ran (TEST_BASELINE present). |
