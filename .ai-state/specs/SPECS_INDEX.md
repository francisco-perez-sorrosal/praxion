...
|------|------|----------|--------|------|------|---------|
| [SPEC_production-gate-cohort_2026-06-26.md](SPEC_production-gate-cohort_2026-06-26.md) | production-gate-cohort | 2026-06-26 | Shipped | Full |  | Turned the analysis's central theme — "designed obligation without a production mechanism" — into reality by adding five... |
