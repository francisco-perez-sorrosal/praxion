...
| REQ-DIAGRAM-06 | `docs/diagrams/architecture/src/architecture.c4`, `docs/diagrams/architecture/rendered/context.d2`, `docs/diagrams/architecture/rendered/context.svg`, `docs/diagrams/architecture/rendered/components.d2`, `docs/diagrams/architecture/rendered/components.svg`, `docs/diagrams/architecture/rendered/index.d2`, `docs/diagrams/architecture/rendered/index.svg` | VERIFICATION_REPORT §2 (ls -la, mtime ≥ source mtime within 60s) |
