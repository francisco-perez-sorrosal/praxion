...
| ID | Tp | Rule | Pass |
|----|----|------|------|
| BC01 | A | Rule exists, is always-loaded, and states the whole contract | Run `python3 scripts/check_behavioral_contract.py --json`. FAIL if the file is missing, is `paths:`-scoped, or omits a behavior name. Spec + golden bad-cases: `scripts/check_behavioral_contract.py` docstring; canary `scripts/test_check_behavioral_contract.py`. |
...
| BC03 | A | Each of the 14 contract-bound agents references the rule | Run `python3 scripts/check_behavioral_contract.py --json`. FAIL per missing or extra citer against the 14 contract-bound agents. Spec + golden bad-cases: `scripts/check_behavioral_contract.py` docstring; canary `scripts/test_check_behavioral_contract.py`. |
| BC04 | A | Tag vocabulary subsection exists with all 6 canonical tags | Run `python3 scripts/check_behavioral_contract.py --json`. FAIL per missing canonical tag in the Behavioral Contract Findings subsection. Spec + golden bad-cases: `scripts/check_behavioral_contract.py` docstring; canary `scripts/test_check_behavioral_contract.py`. |
