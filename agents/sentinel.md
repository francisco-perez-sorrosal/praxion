...
| EC02 | A | No orphaned artifacts | Family: `python3 scripts/check_registry_projection.py --json`; WARN when a skill, command, or rule is not referenced by any agent, CLAUDE.md, or rule. |
