...
| DL06 | A | Cross-reference pointers are reciprocal (both directions set) | Family: `python3 scripts/check_adr_reciprocity.py --json`; WARN per `findings` entry, naming both ids; `retired_by` is exempt. |
