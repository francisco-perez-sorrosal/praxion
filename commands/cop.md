...
6. **Push once**: Push to the remote repository only after all local commits for this command have been created (single push for one commit, or one push after the last of multiple commits).
