...
- [Praxion process economy (2026-09-07)](independent-analysis/process-economy-roadmap.md) — the cost side of the factory comparison: context, ceremony, artifacts and machinery measured against the 2026 agentic-pipeline practice canon and the evidence, with a simplification-first roadmap (instruments → mechanical cuts → structural economies → compete items) and the decisions left to the user
