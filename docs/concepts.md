...
For the full essay -- the two-halves design, the fence convention, the fitness function infrastructure, the architect-validator agent, and how the mechanisms compose -- see [docs/aac-dac.md](aac-dac.md).
