...
| 5 | **`.claude/settings.json` toggles** — enable the observability hook (ships Claude Code events to a localhost Phoenix instance + the `.ai-state/observations.jsonl` WAL) | `.claude/settings.json` | yes (key presence check) |
