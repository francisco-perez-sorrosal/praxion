...
**Remaining Wave 4:** only the deferred **R12b auto-regen hook** (deferred with rationale — a naive finalize regen churns `generated_at`; sentinel F11 backstops staleness). Every other Wave-4 item has landed: **EA-06 · R9-dash · D2** (2026-06-29), **R8 · R19b · EA-09 · EA-10** (2026-06-28), R19a (Wave 1), and the **EA-11 `cleanup_policy` reader** ✅ **closed 2026-06-29** (see the EA-11 reader closure below).
...
**EA-11 reader closure — landed 2026-06-29** (branch `ea11-cleanup-policy-reader`; full agent pipeline architect→planner→test-engineer→implementer→verifier with an intra-step light-review at the RISKY one-way-door seam; ADR draft → dec-draft-1def3b96):
