...
**Wave 5 (R10) — capstone criteria→spec chain eval, landed 2026-06-29** (branch `wave5-r10-criteria-spec-eval`; full agent pipeline researcher→architect→planner→test-engineer→verifier; ADR draft → dec-draft-9abb2fde):
