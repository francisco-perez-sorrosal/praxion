...
| `swe/coding-style.md` | Immutability, data-structure invariants (illegal states, boundary parsing), function/file size, nesting, error handling, naming, validation. Paths: source files across all tracked languages |
