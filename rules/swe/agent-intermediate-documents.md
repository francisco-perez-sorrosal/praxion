...
| `optional-lazy` | the feature was not adopted | `principles.yaml`, `LANDSCAPE_WATCHLIST.md`, the ML `training_runs/` family, `eval_ledger/EVAL_LOG.md` |
| `threshold-lazy` | the project is below the growth threshold | `TEST_TOPOLOGY.md` (M2+ adoption) |
| `future-designed` | the producer is designed but not wired yet | `project_profile.yaml` |
