...
Declarative constraints for the active dashboard runtime in `dashboard_app/` and the stable launcher contract in `scripts/praxion-dashboard`.
...
Rationale: the active runtime depends on a clean server/client boundary.
