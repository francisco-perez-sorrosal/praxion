...
| Discipline-consultant convening + disposition | Gated, never unconditional. Round 0 isolates (no draft access), round 1 challenges; the convener dispositions **per challenge** and appends one `.ai-state/CONSULT_LEDGER.md` row each. One orchestrator-mediated loop-back, then escalate to the user. |
