...
Start at [SKILL.md](SKILL.md); per-language idioms in [references/python-patterns.md](references/python-patterns.md) and [references/typescript-patterns.md](references/typescript-patterns.md) (load only the project's language); schema contracts for model consumers in [references/schema-contract-patterns.md](references/schema-contract-patterns.md).
