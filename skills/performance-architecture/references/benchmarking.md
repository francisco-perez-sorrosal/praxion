...
- **Confidence intervals**: Report results as `mean +/- margin of error` at 95% confidence. To compare two results, interval the **difference** -- do not decide from whether the marginal intervals overlap. The inference rules are owned by [`applied-statistics`](../../applied-statistics/SKILL.md)
