...
- [references/rework-manifest.md](references/rework-manifest.md) -- rework manifest emission (clustering, row-ID computation, dedup, `VERIFIER_FINDINGS.md` template) and the main-agent rework worktree spawn protocol
